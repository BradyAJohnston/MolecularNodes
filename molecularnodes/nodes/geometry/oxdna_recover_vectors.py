...
class OxDNARecoverVectors(AssetGeometryGroup):
    ...
    geometry : InputGeometry
        Vertices and edges generated by `oxDNA Realize Vectors` node
    ...
    def _build_group(self, tree: TreeBuilder[GeometryNodeTree]) -> None:
        geometry = tree.inputs.geometry(
            "Geometry",
            description="Vertices and edges generated by `oxDNA Realize Vectors` node",
        )
        atoms = tree.outputs.geometry(
            "Atoms",
...
ASSET_METADATA = {
    "description": "Extract vector data from helper geometry generated by `oxDNA Realize Vectors`. Outputs standard oxDNA geometry, with vector data stored on the geometry as named attributes.",
