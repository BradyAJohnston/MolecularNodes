...
if TYPE_CHECKING:
    from .. import Molecule, StreamingTrajectory
__all__ = [
    "MoleculeAnnotation",
...
class MoleculeAnnotation(BaseAnnotation):
    ...
    def __init__(self, trajectory):
        ...
        self.trajectory: StreamingTrajectory | Molecule = trajectory
        super().__init__()
...
class AtomInfo(MoleculeAnnotation):
    """
    Atom Info Molecule Annotation
...
class COM(MoleculeAnnotation):
    """
    Center-of-Mass Molecule Annotation
...
class COMDistance(MoleculeAnnotation):
    """
    Distance between Center-of-Masses Molecule Annotation
...
class CanonicalDihedrals(MoleculeAnnotation):
    """
...
class UniverseInfo(MoleculeAnnotation):
    """
    Universe Info Molecule Annotation
...
class SimulationBox(MoleculeAnnotation):
    """
