"""
Managing selections for the ``Molecule``
...
#### See Also
molecularnodes.entities.molecule.base.Molecule : Uses SelectionManager.
...
class SelectionManager:
    ...
    def ui_items(self) -> bpy.types.bpy_prop_collection_idprop:
        """Blender UI property collection that represent the selections for the Molecule.
    ...
    def object(self) -> Object:
        """Blender object associated with the Molecule and SelectionManager.
    ...
    def universe(self) -> Universe:
        """MDAnalysis Universe for the Molecule and SelectionManager.
    ...
    def from_atomgroup(
        ...
        *,
        ...
        Create a selection on the Molecule from an already created ``AtomGroup`` rather than
