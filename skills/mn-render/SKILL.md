...
shadow the venv. `tests/conftest.py` does the same thing. Keep scratch scripts in the
...
The 128 px goldens are too small to show a change. Write a scratchpad script with
