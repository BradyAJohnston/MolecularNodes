...
The Molecular Nodes panel should now be visible in the bottom right of the screen, you may need to scroll down the Scene Properties tab. If the boxes are grayed our and a warning is shown saying there is a missing package, complete the [installation steps](installation.qmd) to ensure Atomium is installed and available.

![](images/CleanShot%202022-05-20%20at%2015.16.57.png)

### Downloading the PDB ID

Input the 4-character code for the structure you wish to download and press the 'Download' button to download and import the structure into blender. If the structure contains information on a biological assembly, tick the 'Build Biological Assembly' when importing to additionally build the assembly on import.
