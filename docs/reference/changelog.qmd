...
## \[[4.4.2](https://github.com/BradyAJohnston/MolecularNodes/releases/tag/v4.4.2)\] - 2025-05-16

### Added

-   Move node definitions to .yml
-   Testing for User-Defined Materials
-   Update tutorial documentation
-   Update citations.yml

### Fixed

-   Resolve relative filepaths when importing via GUI
-   Activate uv venv before running GHA
-   Update data.py source
-   Fix option to remove solvent
-   Fix oxDNA: add resname T to RNA for oxDNA parsing
-   Docstring lint pass

## \[[4.4.1](https://github.com/BradyAJohnston/MolecularNodes/releases/tag/v4.4.1)\] - 2025-04-28

### Fixed

-   Fixed UI fetching from AlphaFold
-   Improved defaults for simulation nodes
-   Ensure correct attribute propagation onto bond geometry
-   Version bumps for Blender and MN

## \[[4.4.0](https://github.com/BradyAJohnston/MolecularNodes/releases/tag/v4.4.0)\] - 2025-04-26

### Added

-   Updated for Blender 4.4 with improved node functionality
-   New experimental simulation nodes
-   Performance improvements and API overhaul
-   Added `ures_id` attribute
-   Added Dihedral Nodes
-   UV Map for Ribbon and "Is Hydrogen" node group
-   Improved API for render engines

### Fixed

-   Multiple API and under-the-hood improvements
-   Fixed cache location
-   Fixed frame mapping
-   Fixed selection from AtomGroup after refactoring
-   Multiple documentation and link fixes
-   Improved error handling and imports

## \[[4.2.12](https://github.com/BradyAJohnston/MolecularNodes/releases/tag/v4.2.12)\] - 2025-02-15
...
-   Generalized update handler
-   Fixed menu issue for node swap
-   Fixed selection refactoring
-   Cleaned up and moved properties to property groups
-   Fixed add-on preferences
-   Fixed several issues referenced in PRs #724 and #725
