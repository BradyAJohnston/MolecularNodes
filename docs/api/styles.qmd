...
```{python}
with mol.styles as input, output:
    input >> g.SetColor(color=n.RandomColor()) >> n.StyleRibbon(selection=n.IsHydgrogen().o.inverted, width=0.3, material=mn.material.AmbientOcclusion()) >> n.StyleSurface(selection=n.SelectResID("10, 200:300"))
```
