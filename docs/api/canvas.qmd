...
t1 = mn.Molecule(u1).add_style("cartoon")
t2 = mn.Molecule(u2)
```
...
t1.add_style("ball_and_stick", quality=4, selection="resid 184")
t1.add_style("spheres", geometry="Instance", selection="resid 1 129")
