...
with mol.tree.reset() as (atoms, join):
    ...
    (
        ...
        >> mg.StyleBallAndStick(
            ...
            material=mn.nodes.material.append_material("MN Ambient Occlusion")
        )
        >> join
    )
    ...
    (
        ...
        >> mg.StyleCartoon(quality=5,loop_radius=0.6, material=mn.nodes.material.append_material("MN Flat"))
        >> join
    )
