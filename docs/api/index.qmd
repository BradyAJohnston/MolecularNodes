...
There are two main classes you will interact with, the [](`~mn.Molecule`) and the [](`~mn.Trajectory`).
...
How you script with each is unfortunately slightly different when it comes to selections, but will hopefully in the future [be unified](https://github.com/BradyAJohnston/MolecularNodes/discussions/949).
