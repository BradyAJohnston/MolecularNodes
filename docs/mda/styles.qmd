...
# add trajectory with a cartoon style
...
Styles can be added to different selections of the universe after it has been added to Blender using the [`add_styles`](../api/reference/entities.Trajectory.html#molecularnodes.entities.Trajectory.add_style) API.
...
t.add_style(style="spheres", selection="resid 1 129")
```
...
t.add_style(style="ball_and_stick", selection=u.select_atoms("resid 180:200"))
```
