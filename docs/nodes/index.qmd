...
of it first before making changes by doing the following:
 ...
 3. It will create a duplicate node group called `MN Style Cartoon.001` for example, 
 which you can now freely edit without changing the other `MN Style Cartoon` node 
 groups.
