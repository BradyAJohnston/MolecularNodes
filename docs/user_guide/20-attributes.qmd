...
Currently, 1 nm is converted to 1 m (1 Blender unit).
Scaling structural coodinates by `0.1` correctly converts them and `0.1` is referred to as the world scale.
...
+-------------------+------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| `res_name`        | `Int::Int`       | Residues are mapped to integer values based on the [lookup table](data-table.qmd#residue-names).                                                                                     |
+-------------------+------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-------------------+------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| `atom_name`       | `Int::Int`       | Atom names are mapped to integer values based on the [lookup table](data-table.qmd#atom-names).                                                                                      |
+-------------------+------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
